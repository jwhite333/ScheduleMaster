...
//{
	...
	//string mystring;
//}
string ConvertorTwo::StdIntToStdString(int integer)
{
...
int ConvertorTwo::StdStringToStdInt(std::string mystring)
{
	int integer = atoi(mystring.c_str());
	return integer;
}
bool ConvertorTwo::VectorSpaceAvailable(std::vector<int> ID, int row)
...
void ConvertorTwo::TroubleShoot(int newI, int newI2, int c2, int c3, int c, vector<vector<string>> SCList)
{
		if(newI == 90 || newI2 == 90)
		{
			ofstream outFile;
...
string ConvertorTwo::NameToID(std::string name, std::vector<vector<string>> SelectedClassList, std::vector<vector<string>> SElist)
{
...
string ConvertorTwo::IDToName(std::string id, std::vector<vector<string>> SelectedClassList, std::vector<vector<string>> SElist)
{
	int size = id.size();
	int integer;
	vector<string>::iterator it;
...
string ConvertorTwo::IDToTeacher(std::string id, std::vector<vector<string>> SelectedClassList, std::vector<vector<string>> SElist)
{
	int size = id.size();
	int integer;
	vector<string>::iterator it;
...
string ConvertorTwo::IDToSize(std::string id, std::vector<vector<string>> SelectedClassList, std::vector<vector<string>> SElist)
{
	int size = id.size();
	int integer;
	vector<string>::iterator it;
